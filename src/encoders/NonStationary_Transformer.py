...
from teleprism.utils.normalization import NormalizationLayer
from teleprism.utils.layers.Transformer_EncDec import Encoder, EncoderLayer
from teleprism.utils.layers.SelfAttention_Family import DSAttention, AttentionLayer
from teleprism.utils.layers.Embed import DataEmbedding
...
class Model(nn.Module):
    """
    Non-stationary Transformer for anomaly detection
    """
    ...
    def forward_encoder(self, x_enc):
        ...
        return enc_out, x_norm, mean_enc, std_enc
    ...
    def forward(self, x_enc):
        enc_out, x_norm, mean_enc, std_enc = self.forward_encoder(x_enc)  # (B, T, C)
        output = self.act(
            enc_out
